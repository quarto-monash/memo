...
This is a Quarto template that assists you in creating a memo, optionally with Monash University branding. There are two versions of the template, one using LaTeX (`memo-pdf`), and one using Typst (`memo-typst`). The latter is faster and more reliable.
